...
public void initialize(SEResourceCache rsc) {
        ...
        rsc.prepare_image("image1","flowers",get_scene_width(), get_scene_height());
        ...
        text2 = add_sprite_for_text("3rd", "myfont");
        text2.move(0.9*get_scene_width(),0.8*get_scene_height());
        text3 = add_sprite_for_text("4th", "myfont");
        text3.move(0.9*get_scene_width(),0.85*get_scene_height());
        text4 = add_sprite_for_text("5th", "myfont");
